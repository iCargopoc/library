...
export const IconColumns = (p: Object): React$Element<*> => (
    <svg id="ng-column-chooser" viewBox="0 0 512 512" {...p}>
...
export const IconAngle = (p: Object): React$Element<*> => (
    <svg id="ng-ico-down-arrow" viewBox="0 0 18 18" {...p}>
        <path d="M17.64 5.154l-.582-.587a.966.966 0 00-.688-.284c-.26 0-.505.1-.688.284l-6.647 6.646L2.382 4.56a.965.965 0 00-.688-.284c-.26 0-.505.101-.688.284l-.583.584a.974.974 0 000 1.375l7.922 7.951c.183.183.427.312.69.312h.003c.26 0 .505-.129.688-.312L17.64 6.54a.983.983 0 00.285-.695c0-.26-.101-.509-.285-.691z" />
    </svg>
);

export const IconKebab = (p: Object): React$Element<*> => (
    <svg id="ng-cabab" viewBox="0 0 4 18" {...p}>
        <g
            transform="translate(0 -1034.362)"
            fillOpacity=".878"
            fillRule="evenodd"
        >
            <ellipse cx="2" cy="1043.362" rx="1.732" ry="1.687" />
            <ellipse cx="2" cy="1036.049" rx="1.732" ry="1.687" />
            <ellipse cx="2" cy="1050.675" rx="1.732" ry="1.687" />
        </g>
    </svg>
);

export const IconFilter = (p: Object): React$Element<*> => (
    <svg id="ng-funnel" viewBox="0 0 12 12" {...p}>
        <path
            d="M11.613.173H.214c-.17 0-.28.177-.17.325L4.22 6.063c.186.237.295.547.295.857v4.857c.016.162.155.265.295.206l2.376-.856c.078-.015.124-.103.124-.177V6.92c0-.31.11-.606.295-.857L11.784.498c.109-.148 0-.325-.171-.325z"
            fillOpacity=".941"
        />
    </svg>
);
...
export const IconShare = (p: Object): React$Element<*> => (
    <svg id="ng-share" viewBox="0 0 512 512" {...p}>
        <g id="ng-share">
            <path
                className="cls-1"
...
export const IconGroupSort = (p: Object): React$Element<*> => (
    <svg id="ng-latest" viewBox="0 0 16 16" {...p}>
...
export const IconSort = (p: Object): React$Element<*> => (
    <svg id="ng-down-xs" viewBox="0 0 8 8" {...p}>
        <path d="M.07 2.027h7.86L3.984 5.973z" fillRule="evenodd" />
    </svg>
);

export const IconPencil = (p: Object): React$Element<*> => (
    <svg id="ng-edit" viewBox="0 0 383.947 383.947" {...p}>
        <g>
...
export const IconTick = (p: Object): React$Element<*> => (
    <svg id="ng-tick" viewBox="0 0 24 24" {...p}>
...
export const IconCancel = (p: Object): React$Element<*> => (
    <svg id="ng-close-x" viewBox="0 0 12 12" {...p}>
...
export const IconSearch = (p: Object): React$Element<*> => (
    <svg id="ng-search" viewBox="0 0 18 18" {...p}>
        <path
...
export const IconDragHorizontal = (p: Object): React$Element<*> => (
    <svg id="ng-drag-hor" viewBox="0 0 512 512" {...p}>
        <g id="ng-drag-hor">
...
export const IconCsv = (p: Object): React$Element<*> => (
    <svg id="ng-csv" viewBox="0 0 512 512" {...p}>
...
export const IconExcel = (p: Object): React$Element<*> => (
    <svg id="ng-excel" viewBox="0 0 512 512" {...p}>
...
export const IconPdf = (p: Object): React$Element<*> => (
    <svg id="ng-pdf" viewBox="0 0 512 512" {...p}>
        <g id="ng-pdf">
            <path
                className="cls-1"
...
export const IconDragVertical = (p: Object): React$Element<*> => (
    <svg id="ng-drag-ver" viewBox="0 0 512 512" {...p}>
        <g id="ng-drag-ver">
...
export const SortCopy = (p: Object): React$Element<*> => (
    <svg id="ng-copy" viewBox="0 0 512 512" {...p}>
...
export const SortDelete = (p: Object): React$Element<*> => (
    <svg id="ng-trash" viewBox="-40 0 11.2 11.2" {...p}>
        <g>
...
export const IconRefresh = (p: Object): React$Element<*> => (
    <svg id="ng-refresh" viewBox="0 0 491.236 491.236" {...p}>
...
export const IconExpand = (p: Object): React$Element<*> => (
    <svg id="ng-plus" viewBox="0 0 512 512" {...p}>
...
export const IconCollapse = (p: Object): React$Element<*> => (
    <svg id="ng-minus" viewBox="0 0 512 512" {...p}>
        <path d="M438.9 216H73.1c-22.1 0-40 17.9-40 40s17.9 40 40 40h365.7c22.1 0 40-17.9 40-40 .1-22.1-17.8-40-39.9-40z" />
        <path d="M438.9 216H73.1c-22.1 0-40 17.9-40 40s17.9 40 40 40h365.7c22.1 0 40-17.9 40-40 .1-22.1-17.8-40-39.9-40z" />
    </svg>
);

export const IconPinColumn = (p: Object): React$Element<*> => (
    <svg id="ng-paperpin" viewBox="0 0 8 8" {...p}>
        <path d="M7.834 2.57L5.43.166a.49.49 0 00-.694 0l-.023.022a.49.49 0 000 .694l.034.034-2.057 1.73-.06-.06a.36.36 0 00-.26-.102c-.172 0-.371.097-.534.26l-.139.139a.181.181 0 000 .257L2.88 4.323.07 7.485a.275.275 0 00.01.378l.058.057a.274.274 0 00.377.01l3.162-2.81L4.86 6.303a.18.18 0 00.257 0l.14-.14c.27-.27.339-.612.158-.793l-.06-.06 1.73-2.057.033.034a.49.49 0 00.694 0l.022-.023a.49.49 0 000-.694z" />
    </svg>
);
