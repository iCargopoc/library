    ...
    const columns = [
        {
            ...
            accessor: "travelId",
            width: 50,
            widthGrow: 1, // This is the factor that Grid uses to identify how to allocate the width of a hidden column to other columns.
            display: false, // False if this column has to be hidden by default. Default value for this property is true.
            disableSortBy: true,
            disableResizing: true,
            isSortable: true, // This column will appear in Sort By dropdown in groupsort overlay only if 'isSortable' value is true.
        ...
        },
        {
            ...
            accessor: "flight",
            isArray: true, // Pass this as true, if the value of 'flight' node in the data is an array.
            width: 100,
            innerCells: [
                {
                    Header: "Flight No",
                    accessor: "flightno",
                    isSortable: true  // This column header will appear in Sort By dropdown and this innerCell header will appear in Sort On dropdown, of Group sort overlays
                },
                {
                    Header: "Date",
                    accessor: "date"
